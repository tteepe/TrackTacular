...
class trackingEvaluation(object):
    ...
    def __init__(self, t_sha, gt_path="../data/cache", max_truncation = 0, min_height = 0.1, max_occlusion = 2, \
        ...
        # data and parameter
        self.gt_path           = os.path.join(gt_path, "gt")
        self.t_sha             = t_sha
        self.t_path            = os.path.join(gt_path, 'pred')
